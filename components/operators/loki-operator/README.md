# Community Loki Operator

Install Community Loki Operator.
...
If you have cloned the `gitops-catalog` repository, you can install Community Loki Operator based on the overlay of your choice by running from the root (`gitops-catalog`) directory.
